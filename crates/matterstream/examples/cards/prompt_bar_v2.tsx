...
<>
  <Slab x={0} y={0} w={1000} h={56} radius={28} color="#1E1E2EFF" layout="hstack" padding={4} gap={4} valign="center">
    ...
    <Slab w={44} h={48} radius={24} color="#2A2A3CFF" action="toggle_listening" halign="center" valign="center" />
    ...
    <IconButton w={68} h={48} radius={24} color="#4466FFFF" action="prompt_send" label=">" labelColor="#FFFFFFFF" />
